#!/usr/bin/env python3
"""gen_attn_pkgs2.py — ggml-barra v2.1: GETRENNTE q/k/v/o-Packages je Layer mit ZEILEN-NORMIERTER
Kalibrierung (jede Token-Zeile auf max|x|=1) gegen massive Aktivierungen + getrennte Output-Skalen.

  python3 gen_attn_pkgs2.py <gguf> <outdir> [S=512]
...
with open(os.path.join(OUT,"attn2.meta"),"w") as f:

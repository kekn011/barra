#!/system/bin/sh
# v2.2: 144 Packages aus attn4b3 kompilieren, dann tpud damit starten
setenforce 0 2>/dev/null
T=/data/local/tmp; A=$T/attn4b3
...
i=0
while [ $i -lt $NL ]; do
  for base in q_L$i k_L$i v_L$i o_L$i; do

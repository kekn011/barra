#!/bin/bash
set -x -e
export OSTYPE=mingw32; export OS=Windows_NT; export HOSTTYPE=x86_64
mkdir -p lib/lib bin
...
$CC -std=c++17 -I../include -Iinclude -I../base/include -DLIBLOG_LOG_TAG=1006 -DSNET_EVENT_LOG_TAG=1397638484 -include /tmp/lpwin/atomic_shim.hpp ${CFLAGS} -c log_event_list.cpp log_event_write.cpp logger_name.cpp logger_read.cpp logger_write.cpp logprint.cpp properties.cpp ${src}
...
cd ../libsparse
$CC -std=c++17 -I../include -I../zlib ${CFLAGS} -c backed_block.cpp output_file.cpp sparse.cpp sparse_crc32.cpp sparse_err.cpp sparse_read.cpp
...
src=""   # mingw: OPENSSL_NO_ASM -> C-Fallbacks, keine NASM-asm
